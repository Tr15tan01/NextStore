  ...
  return (
    <section>
      ...
      <p className="mt-6 text-lg tracking-wide leading-8 max-w-2xl mx-auto text-muted-foreground">
        Welcome to NextStore, your premier destination for cutting-edge products
        and exceptional service! At NextStore, we curate a diverse selection of
        high-quality items ranging from the latest electronics to stylish home
        ...
        choosing us as your go-to retail partner!
      </p>
    </section>
  );
}
